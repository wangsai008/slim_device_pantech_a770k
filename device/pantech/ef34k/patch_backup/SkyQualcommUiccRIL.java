...
public class SkyQualcommUiccRIL extends QualcommSharedRIL implements CommandsInterface {
   ...
   @Override
    ...
    sendSMS (String smscPDU, String pdu, Message result) {
        ...
        sendSMS(null, pdu, result, 1);
    }
	
  public void sendSMS(String paramString1, String paramString2, Message paramMessage, int paramInt)
  {
    RILRequest localRILRequest = RILRequest.obtain(26, paramMessage);
    ...
    riljLog(localRILRequest.serialString() + "> " + requestToString(localRILRequest.mRequest) + "msgCount : " + paramInt);
